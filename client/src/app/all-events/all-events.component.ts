...
export class AllEventsDetails implements OnInit {
    ...
    filterEvents(): void{
        ...
        this.filteredEvents = this.events.filter(e => 
            // const title = e.title?.toLowerCase().includes(term) || '';
            // const description = e.description?.toLowerCase().includes(term) || '';
            // const location = e.location?.toLowerCase().includes(term) || '';
            // const status = e.status?.toLowerCase().includes(term) || '';
            // const scheduleDate = new Date(e.schedule);
            // const day = scheduleDate.getDate().toString();
            // const monthShort = scheduleDate.toLocaleString('default', { month: 'short'}).toLowerCase();
            // const monthFull = scheduleDate.toLocaleString('default', { month: 'long'}).toLowerCase();
            // const year = scheduleDate.getFullYear().toString();
            // return (
            //     title.includes(term) ||
