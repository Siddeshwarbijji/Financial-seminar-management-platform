...
public class RegisterAndLoginController {
    ...
    @PostMapping("/api/user/check-user")
    public ResponseEntity<Map<String, Object>> checkUserExists(@RequestBody Map<String, String> payload){
        ...
        response.put("emailMessage", emailExists ? "Email is already in use" : "");
        response.put("usernameMessage", usernameExists ? "Username is already in use": "");
